...
function initPlayer($joueur)
{
    ...
    $listeConstructions = [
        ...
        'lieur' => [
            ...
            'revenu' => chip('-' . floor((1- 1/bonusLieur($constructions['lieur'])) * 100) . '%', '<img src="images/batiments/tempsMolecule.png" alt="tpsMol" style="border-radius:0px;width:22px;height:22px"/>', "white", "", true),
            'revenu1' => chip('-' . floor((1- 1/bonusLieur($niveauActuelLieur['niveau'] + 1)) * 100) . '%', '<img src="images/batiments/tempsMolecule.png" alt="tpsMol" style="border-radius:0px;width:22px;height:22px"/>', "white", "", true),
            'effetSup' => '',
